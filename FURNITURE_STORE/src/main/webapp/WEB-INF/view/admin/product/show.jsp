...
<html lang="en">
  <head>
    ...
    <title>Quản lý sản phẩm - Furniture Store</title>
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="fas fa-couch me-2" style="color: #81c408;"></i>Quản lý sản phẩm</h1>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group-action">
                            <a href="/admin/product/${product.id}" class="btn btn-success btn-sm">
                              <i class="fas fa-eye"></i> Xem
                            </a>
                            <a href="/admin/product/update/${product.id}" class="btn btn-warning btn-sm">
