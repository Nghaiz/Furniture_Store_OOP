...
<html lang="en">
  <head>
    ...
    <title>Quản lý người dùng - Furniture Store</title>
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="fas fa-users me-2" style="color: #81c408;"></i>Quản lý người dùng</h1>
            ...
            <div class="row">
              <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <h3><i class="fas fa-list me-2"></i>Danh sách người dùng</h3>
                  ...
                  <tbody>
                    <c:forEach var="user" items="${users.content}">
                      <tr>
                        ...
                        <td>
                          <i class="fas fa-envelope me-2" style="color: #81c408;"></i>
                          ${user.email}
                        </td>
                        <td>
