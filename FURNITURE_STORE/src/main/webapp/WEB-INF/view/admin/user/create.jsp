...
<head>
    ...
    <title>Thêm người dùng - Furniture Store</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"><i class="fas fa-user-plus me-2" style="color: #81c408;"></i>Thêm người dùng</h1>
                        ...
                        <div class="col-lg-8 col-md-10 col-12">
                            <div class="card">
                                <div class="card-header" style="background: #81c408; color: white;">
                                    <h5 class="mb-0"><i class="fas fa-user me-2"></i>Thông tin người dùng mới</h5>
                                </div>
                                <div class="card-body">
                                    <form:form method="post" action="/admin/user/create" modelAttribute="newUser" 
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <form:input type="email" class="form-control ${not empty errorEmail ? 'is-invalid' : ''}" 
                                                path="email" placeholder="Nhập địa chỉ email" />
                                            ${errorEmail}
                                        </div>
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <label class="form-label"><i class="fas fa-lock me-1" style="color: #81c408;"></i>Mật khẩu:</label>
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <form:input type="text" class="form-control ${not empty errorPhone ? 'is-invalid' : ''}" 
                                                path="phone" placeholder="Nhập số điện thoại" />
                                            ${errorPhone}
                                        </div>
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <form:input type="text" class="form-control ${not empty errorFullname ? 'is-invalid' : ''}" 
                                                path="fullName" placeholder="Nhập họ và tên" />
                                            ${errorFullname}
                                        </div>
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            <label class="form-label"><i class="fas fa-user-tag me-1" style="color: #81c408;"></i>Vai trò:</label>
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            <label for="avatarFile" class="form-label"><i class="fas fa-image me-1" style="color: #81c408;"></i>Ảnh đại diện:</label>
                                            <input class="form-control" type="file" id="avatarFile" accept=".png, .jpg, .jpeg" name="imageFile" />
                                        </div>

                                        <div class="col-12 mb-3">
                                            <img style="max-height: 250px; display: none; border-radius: 8px;" alt="Xem trước ảnh đại diện" id="avatarPreview" />
                                        </div>
