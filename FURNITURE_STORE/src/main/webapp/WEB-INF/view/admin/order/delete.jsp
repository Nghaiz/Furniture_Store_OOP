...
<head>
    ...
    <title>Xóa đơn hàng - Furniture Store</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"><i class="fas fa-trash-alt me-2" style="color: #dc3545;"></i>Xóa đơn hàng</h1>
                        ...
                        <div class="col-lg-6 col-md-8 col-12">
                            <div class="card border-danger">
                                <div class="card-header bg-danger text-white">
                                    <h5 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>Xác nhận xóa đơn hàng #${id}</h5>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-danger">
                                        <i class="fas fa-warning me-2"></i>Bạn có chắc chắn muốn xóa đơn hàng này không? Hành động này không thể hoàn tác.
                                    </div>
