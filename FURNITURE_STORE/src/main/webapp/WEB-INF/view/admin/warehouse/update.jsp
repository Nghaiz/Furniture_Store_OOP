...
<head>
    ...
    <title>Cập nhật kho hàng - Furniture Store</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"><i class="fas fa-edit me-2" style="color: #81c408;"></i>Cập nhật kho hàng</h1>
                        ...
                        <div class="col-lg-8 col-md-10 col-12">
                            <div class="card">
                                <div class="card-header" style="background: #81c408; color: white;">
                                    <h5 class="mb-0"><i class="fas fa-warehouse me-2"></i>Chỉnh sửa thông tin kho hàng</h5>
                                </div>
                                <div class="card-body">
                                    <form:form method="post" action="/admin/warehouse/update" modelAttribute="newWarehouse" class="row">
                                            ...
                                            <select class="form-select" name="productId" required>
                                                <c:forEach var="product" items="${products}">
                                                    <option value="${product.id}" 
                                                        ${product.id == newWarehouse.product.id ? 'selected' : ''}>
                                                        ${product.name}
                                                    </option>
                                                </c:forEach>
                                            </select>
