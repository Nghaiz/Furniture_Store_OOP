    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                ...
                <title>Quên mật khẩu - FURNITURE STORE</title>
                ...
                <div class="wrapper">
                    <div class="form-box">
                        ...
                        <p class="form-subtitle">
                            Nhập địa chỉ email của bạn và chúng tôi sẽ gửi hướng dẫn đặt lại mật khẩu cho bạn.
                        </p>
                        ...
                        <div class="info-box">
                            ...
                            <strong>Lưu ý:</strong> Liên kết đặt lại mật khẩu sẽ hợp lệ trong 24 giờ và chỉ có thể được
                            sử dụng một lần.
                        </div>
