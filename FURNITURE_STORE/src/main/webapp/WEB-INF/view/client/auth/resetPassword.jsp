    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                ...
                <title>Đặt lại mật khẩu - FURNITURE STORE</title>
                            ...
                            <div class="password-strength">
                                ...
                                <ul id="password-requirements">
                                    <li id="req-length" class="invalid">
                                        <ion-icon name="close-circle"></ion-icon> Tối thiểu 6 ký tự
                                    </li>
                                    <li id="req-lowercase" class="invalid">
                                        <ion-icon name="close-circle"></ion-icon> Ít nhất một chữ cái viết thường
                                    </li>
                                    <li id="req-uppercase" class="invalid">
                                        <ion-icon name="close-circle"></ion-icon> Ít nhất một chữ cái viết hoa
                                    </li>
                                    <li id="req-number" class="invalid">
                                        <ion-icon name="close-circle"></ion-icon> Ít nhất một số
                                    </li>
                                </ul>
                            </div>
